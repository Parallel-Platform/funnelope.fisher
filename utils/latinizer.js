...
var latinizer = {
    latinize : function (word) {
        return word.replace(/[^A-Za-z0-9\[\] ]/g, function (x) { return Latinise.latin_map[x] || x; });
    },

    isLatin : function (word) {
        return word == this.latinise();
    }
}

module.exports = latinizer;
